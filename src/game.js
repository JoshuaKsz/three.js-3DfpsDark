...
export default class Game {
    constructor (scene, camera, renderer, world, width = window.innerWidth, height = window.innerHeight, player) {
        ...
        this.enemy_node = [new EnemyBody(new CANNON.Vec3(-57.1, 5.54, 24.34), new SoliderBody(world, scene, new CANNON.Vec3(-57.1, 5.54, 24.34), new CANNON.Vec3(1, 1.5, 1), new CANNON.Vec3(1, 1, 1), 1))];
